...
export const ADMIN_ACCESSORY_SESSION_KEY = 'fastlane.admin.accessory.prototype.v3'
export const ADMIN_ACCESSORY_SESSION_VERSION = 3
...
export function restoreAdminAccessoryDraft(serialized: string, rootCategoryId: string) {
  ...
  if (!snapshot || snapshot.schemaVersion !== ADMIN_ACCESSORY_SESSION_VERSION) {
