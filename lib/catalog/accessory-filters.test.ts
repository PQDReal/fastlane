...
function product(overrides: Partial<CatalogProduct> = {}): CatalogProduct {
  return {
    ...
    serviceLabels: [{
      id: 'installation', code: 'installation', name: 'Có lắp đặt',
      description: null, displayOrder: 10, isActive: true, assignmentCount: 0,
    }],
...
describe('accessory filters', () => {
  ...
  it('requires every selected service with AND semantics', () => {
    const showroom = product({
      ...
      serviceLabels: [{
        id: 'showroom', code: 'showroom_pickup', name: 'Nhận tại showroom',
        description: null, displayOrder: 20, isActive: true, assignmentCount: 0,
      }],
    })
