...
function product(
  ...
  return {
    ...
    serviceLabels: [],
    collectionMemberships: sourceCategory ? [{
      id: `membership-${name}`,
      sourceSystem: 'vinfast_accessory',
      isPrimary: true,
      firstSeenAt: '2026-07-29T00:00:00.000Z',
      lastSeenAt: '2026-07-29T00:00:00.000Z',
      metadata: {},
      collection: {
        id: `category-${sourceCategory}`,
        parentId: null,
        kind: 'CATEGORY',
        sourceSystem: 'vinfast_accessory',
        sourceKey: sourceCategory,
        slug: normalizeCatalogText(sourceCategory).replace(/ /g, '-'),
        name: sourceCategory,
        vehicleFilterMode: 'NONE',
        displayOrder: 0,
        metadata: {},
        vehicleModel: null,
      },
