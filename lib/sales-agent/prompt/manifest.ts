...
export const SALES_AGENT_PROMPT_MANIFEST = {
  ...
  systemPrompt: [
    ...
    '   - Nếu dữ liệu kết quả (snippets) có chứa thông tin `imageUrl`, hệ thống sẽ tự động vẽ hình ra màn hình. AI **TUYỆT ĐỐI KHÔNG ĐƯỢC BẢO LÀ CHƯA CÓ HÌNH MINH HOẠ**. Thay vào đó, AI chỉ việc mô tả chi tiết: "Dưới đây là hình minh họa trực tiếp, số 2 là cổng sạc...". Cùng lúc đó, khung bên phải sẽ hiển thị toàn bộ bài viết, hãy gợi ý khách hàng xem thêm bên phải nếu cần.',
