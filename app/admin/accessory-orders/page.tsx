...
const summarySelection = 'id,order_number,status,refund_status,total_amount,created_at,customer:users!orders_customer_id_fkey!inner(id,email),order_items(id,product_name_snapshot,quantity),refund_attempts:vnpay_refund_attempts(status,requested_at,updated_at)'
