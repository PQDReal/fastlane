...
export function AccessoryTemplatesManager() {
  ...
  const activeContentSectionIndex = activeContentSection
    ? form.sections.findIndex((section) => section.key === activeContentSection.key)
    : -1
