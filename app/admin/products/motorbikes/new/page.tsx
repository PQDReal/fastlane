    ...
    setForm((current) => {
      ...
      return {
        ...
        versions: current.versions.map((version) => {
          ...
          return { ...version, stock_by_color: stockByColor, compatible_colors: (version.compatible_colors ?? current.colors.map((color) => color.color_name)).filter((name) => name !== removedName) }
        }),
      }
    })
  }
            ...
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">Thêm các tùy chọn màu kèm ảnh tương ứng và swatch màu sắc.</p>
                </div>
                <button
                  type="button"
                  onClick={addColor}
