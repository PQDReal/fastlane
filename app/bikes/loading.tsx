      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-12 py-16 w-full">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex w-full flex-wrap items-center gap-4 md:w-auto">
            <div className="relative w-full md:w-[336px] h-12 bg-slate-100 animate-pulse rounded-full"></div>
            <div className="h-12 w-28 bg-slate-100 animate-pulse rounded-full"></div>
          </div>
