...
const LIMITED_PARTS = [
  {
    ...
    summary:
      "Thời hạn phụ thuộc dòng xe, điều kiện sử dụng tiêu chuẩn hoặc mục đích dịch vụ thương mại.",
    details: [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    summary:
      "Bảo hành tấm kim loại bị xuyên thủng do lỗi vật liệu hoặc lắp ráp trong điều kiện vận hành bình thường.",
    details: [
  ...
  },
  {
    ...
    icon: Wrench,
    summary:
      "Bao gồm giảm xóc, thanh ổn định, tay đòn, khớp bi và các liên kết liên quan.",
    details: [
  ...
  },
  {
    ...
    icon: CircleDot,
    summary:
      "Lốp theo xe được xử lý theo chính sách riêng của nhà sản xuất lốp và điều kiện thị trường.",
    details: [
...
const FAQS = [
  ...
  {
    question:
      "Phụ tùng mua chính hãng nhưng lắp ở xưởng ngoài có được bảo hành không?",
    answer:
    ...
    <article className="space-y-14 animate-in fade-in duration-200 sm:space-y-16">
      <header className="border-b border-slate-200 pb-8">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-600 sm:text-base">
          Chính sách bảo hành dài hạn giúp bảo vệ quyền lợi chủ xe và duy trì sự
          an tâm trong suốt quá trình sử dụng.
        </p>
      ...
      >
        ...
        <p className="mt-5 border-l-2 border-[#836100] bg-[#836100]/5 px-5 py-4 text-sm leading-6 text-slate-700">
          Khi việc sửa chữa có thể khắc phục lỗi chất lượng, vật liệu hoặc lắp
          ráp, chính sách không mặc nhiên bao gồm việc thu hồi và đổi sang một
          xe khác.
        </p>
      </section>
      ...
      >
            ...
            >
              <div className="flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <h4 className="mt-2 text-lg font-semibold leading-7 text-slate-900">
                    {item.models.join(", ")}
                  </h4>
                </div>
              </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                <div className="border border-[#e6b32e]/40 bg-[#fffaf0] p-4">
                  <p className="text-xs font-bold uppercase tracking-wider text-slate-500">
                    Bảo hành xe
                  </p>
                  <p className="mt-2 text-lg font-semibold leading-6 text-[#836100]">
                    {item.warrantyTerm}
                  </p>
                </div>
        ...
        {warranties.length === 0 && (
          <p className="border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-900">
            Chưa có dữ liệu bảo hành ô tô được publish cho lựa chọn hiện tại.
          </p>
        )}
        ...
        {warranties.some((item) => item.commercialWarranty) && (
          <div className="mt-5 border border-slate-200 bg-slate-50 p-5">
            <h4 className="font-semibold text-slate-900">
              Xe đang hoặc từng sử dụng cho dịch vụ thương mại
            </h4>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Ô tô xăng: 12 tháng hoặc 20.000 km. Ô tô điện: 2 năm hoặc 40.000
              km.
            </p>
          </div>
          <div className="border border-slate-200 bg-white p-6">
          ...
          <div className="border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Ô tô xăng: 1 năm hoặc 20.000 km. Ô tô điện: 1 năm, không giới hạn
              km.
            </p>
          </div>
        </div>
        <p className="mt-5 text-sm leading-6 text-slate-600">
          Khách hàng cần lưu giữ lệnh sửa chữa, quyết toán và hóa đơn. Phụ tùng
          mua nhưng không được thay tại xưởng hoặc nhà phân phối ủy quyền có thể
          không đủ điều kiện áp dụng chính sách.
        </p>
      </section>

      <section
        id="accessory-warranty"
        className="scroll-mt-28 border-b border-slate-200 pb-14 sm:pb-16"
      >
        ...
        <div className="overflow-hidden border border-slate-200 bg-white">
          <div className="grid border-b border-slate-200 sm:grid-cols-[240px_1fr]">
            ...
            <p className="px-5 py-4 text-sm leading-6 text-slate-600">
              2 năm, không giới hạn số km kể từ ngày mua.
            </p>
          </div>
          <div className="grid border-b border-slate-200 sm:grid-cols-[240px_1fr]">
            <p className="bg-slate-50 px-5 py-4 text-sm font-semibold text-slate-900">
              Nhóm phụ kiện lắp cố định
            </p>
            <p className="px-5 py-4 text-sm leading-6 text-slate-600">
              Điều kiện tiêu chuẩn: 5 năm; điều kiện dịch vụ thương mại: 3 năm,
              không giới hạn km với dòng xe áp dụng.
            </p>
          </div>
          <div className="grid sm:grid-cols-[240px_1fr]">
            <p className="bg-slate-50 px-5 py-4 text-sm font-semibold text-slate-900">
              Phụ kiện không lắp cố định
            </p>
            <p className="px-5 py-4 text-sm leading-6 text-slate-600">
              Bộ sạc di động, bộ sửa chữa lốp, thảm sàn, rèm trần và các phụ
              kiện tương tự: 2 năm, không giới hạn km.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="mt-5 flex gap-3 border border-amber-200 bg-amber-50 p-5">
          ...
          <p className="text-sm leading-6 text-amber-900">
            Thông tin chi tiết và các ngoại lệ cụ thể được quy định trong sổ bảo
            hành đi kèm từng sản phẩm.
          </p>
        </div>
      </section>
      ...
      <section id="warranty-support" className="scroll-mt-28">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-2 text-xl font-semibold text-slate-900 transition group-hover:text-[#836100]">
              1900 xxxx
            </p>
        ...
        <div className="mt-6 flex flex-col gap-3 border border-slate-200 bg-slate-50 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-slate-600">
              Cần xác nhận điều kiện cho xe cụ thể? Hãy liên hệ hotline hoặc
              xưởng dịch vụ để kiểm tra hồ sơ và tình trạng thực tế.
            </p>
          </div>
        </div>
