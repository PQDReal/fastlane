...
const BENEFITS = [
  ...
  {
    title: "Kỹ thuật viên chuyên môn",
    text: "Đội ngũ được đào tạo theo tiêu chuẩn kỹ thuật dành cho từng dòng xe.",
  },
  {
    title: "Chi phí minh bạch",
    text: "Hạng mục được kiểm tra, tư vấn và xác nhận trước khi thực hiện.",
  },
  {
...
const PROCESS_STEPS = [
  {
    number: "01",
    title: "Nhắc bảo dưỡng & Theo dõi",
    text: "Nhận thông báo đến kỳ và theo dõi hạng mục cần thực hiện theo dòng xe.",
  },
  {
    number: "02",
  ...
  },
  {
    number: "03",
    title: "Bảo dưỡng",
    text: "Kỹ thuật viên thực hiện theo checklist và lịch trình của dòng xe.",
  },
  {
    number: "04",
    title: "Bàn giao xe",
    text: "Giải thích kết quả, công việc đã thực hiện và khuyến nghị tiếp theo.",
  },
  {
    number: "05",
    ...
    <article className="space-y-14 animate-in fade-in duration-200 sm:space-y-16">
      <header className="border-b border-slate-200 pb-8">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-600 sm:text-base">
          Bảo dưỡng định kỳ giúp phát hiện sớm hư hỏng, duy trì trạng thái vận
          hành ổn định và là điều kiện quan trọng để bảo đảm quyền lợi bảo hành.
        </p>
      </header>
      ...
      >
        <Heading
          index="01"
          title={
            isCar ? "Lịch trình & Hạng mục bảo dưỡng" : "Danh mục bảo dưỡng"
          }
        ...
        <div className="border border-slate-200 bg-white p-5 sm:p-6">
          <div className="grid gap-5 border-b border-slate-200 pb-5 md:grid-cols-[1fr_320px] md:items-end">
            <div>
              <p className="text-sm font-semibold text-slate-900">
                Dòng xe thuộc danh mục chính thức
              </p>
          ...
          {selected && (
            <>
              ...
              <div className="mt-6 grid gap-px overflow-hidden border border-slate-200 bg-slate-200 sm:grid-cols-2">
                {(isCar
                  ? selected.checklist.flatMap((group) =>
                  ...
                  <div
                    key={item}
                    className="flex gap-3 bg-white p-4 text-sm leading-6 text-slate-700"
                  >
                    <CheckCircle2
                      size={16}
          ...
          {!selected && (
            <p className="mt-6 border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-900">
              Chưa có lịch bảo dưỡng được publish cho loại xe này.
            </p>
          )}
        </div>
      </section>
      ...
      {isCar && (
        ...
        >
          <Heading
            ...
            description="Quy trình 5 bước từ tiếp nhận yêu cầu đến chăm sóc sau dịch vụ."
          />
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold">
                Liên hệ trước để giảm thời gian chờ
              </p>
              <p className="mt-1 text-sm text-slate-300">
                Xưởng sẽ tiếp nhận thông tin xe và chuẩn bị hạng mục phù hợp
                trước khi bạn đến.
              </p>
            </div>
          </div>
